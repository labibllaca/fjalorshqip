...
const MainLayout = () => {
  ...
  return (
    <EntryContext.Provider value={{ entry, setEntry, crossRef, setCrossRef: handleSetCrossRef, panelOpen: drawerOpen, togglePanel: toggleDrawer }}>
      ...
      <footer className="content-footer">
        <div className="footer-icons">
          <Link to="/rreth" className="footer-icon" aria-label="Rreth">
