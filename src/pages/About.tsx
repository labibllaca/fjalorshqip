const About = () => {
  return (
    <div style={{ maxWidth: 620, margin: '0 auto', lineHeight: 1.8 }}>
      ...
      <p>
        Fjalët e definicionet janë grumbullue prej burimesh t'ndryshme — fjalorë t'shtypun,
        fjalorë online ekzistues, e kontribute personale. Cilësia e definicioneve a mundet
